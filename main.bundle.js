...
var checkTextForColors = function checkTextForColors(textArray) {
  ...
  textArray.forEach(function (word) {
    var downCasedWord = word.toLowerCase();
...
var deleteDuplicates = function deleteDuplicates(array) {
  var uniqueArray = [];
...
var $ = __webpack_require__(0);
var colorObject = __webpack_require__(1);

var appendColorSwatches = function appendColorSwatches(colorArray) {
  $('article.colorized-text').empty();
  colorArray.forEach(function (color) {
    var hexCode = colorObject[color];
